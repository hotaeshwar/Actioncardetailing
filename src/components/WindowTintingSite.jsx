...
const WindowTintingSite = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="bg-white py-16 sm:py-20 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="h-8 md:h-10 mb-4">
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold typewriter" style={{ color: '#1393c4' }}>
                {runningTexts[currentText]}
              </h3>
            </div>
            <p className="text-lg sm:text-xl md:text-2xl mb-8 font-medium" style={{ color: '#1393c4' }}>
              Before It Happens
            </p>
            <button
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight" style={{ color: '#1393c4' }}>
                WHY WINDOW TINTING?
              </h2>
              <div className="mb-8">
                <img
            ...
            <div className="space-y-8">
              <div className="p-6 rounded-xl" style={{ backgroundColor: '#f0f9ff', borderColor: '#1393c4', borderWidth: '1px' }}>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 leading-tight" style={{ color: '#1393c4' }}>
                  Experience a New Level of Heat Rejection, UV Protection, & Good Looks
                </h3>
                <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-6" style={{ color: '#1393c4' }}>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="animate-card p-6 rounded-xl text-white" style={{ backgroundColor: '#1393c4' }}>
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-bold text-white text-sm sm:text-base md:text-lg">Superior Heat Rejection</h4>
                  </div>
                  <p className="text-white text-sm sm:text-base">Our multilayer nano-ceramic particle technology blocks up to 88% of the infrared heat</p>
                </div>

                <div className="animate-card p-6 rounded-xl text-white" style={{ backgroundColor: '#1393c4' }}>
                  <div className="flex items-center mb-3">
                    <Shield className="text-white mr-3" size={24} />
                    <h4 className="font-bold text-white text-sm sm:text-base md:text-lg">UV Ray Protection</h4>
                  </div>
                  <p className="text-white text-sm sm:text-base">XPEL PRIME XR PLUS provides SPF 1,000 protection that effectively blocks over 99% of harmful UV rays</p>
                </div>

                <div className="animate-card p-6 rounded-xl text-white" style={{ backgroundColor: '#1393c4' }}>
                  <div className="flex items-center mb-3">
                    <Zap className="text-white mr-3" size={24} />
                    <h4 className="font-bold text-white text-sm sm:text-base md:text-lg">Greater Clarity</h4>
                  </div>
                  <p className="text-white text-sm sm:text-base">Advanced nano construction in XPEL PRIMETM XR provides superior performance without reducing outbound visibility</p>
                </div>

                <div className="animate-card p-6 rounded-xl text-white" style={{ backgroundColor: '#1393c4' }}>
                  <div className="flex items-center mb-3">
                    <Wifi className="text-white mr-3" size={24} />
                    <h4 className="font-bold text-white text-sm sm:text-base md:text-lg">Crystal Clear Signal</h4>
                  </div>
                  <p className="text-white text-sm sm:text-base">In the digital world, clear communication is key. PRIME XR PLUS construction will not interfere with radio, cellular, or Bluetooth signals</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-16 leading-tight" style={{ color: '#1393c4' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="animate-card text-center">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4" style={{ color: '#1393c4' }}>Select the Film</h3>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-white px-3 py-2 rounded text-sm sm:text-base" style={{ backgroundColor: '#1393c4', opacity: 0.7 }}>
                    <span>PRIME CS</span>
                    <span>GOOD</span>
                  </div>
                  <div className="flex items-center justify-between text-white px-3 py-2 rounded text-sm sm:text-base" style={{ backgroundColor: '#1393c4', opacity: 0.85 }}>
                    <span>PRIME HP</span>
                    <span>BETTER</span>
                  </div>
                  <div className="flex items-center justify-between text-white px-3 py-2 rounded text-sm sm:text-base" style={{ backgroundColor: '#1393c4' }}>
                    <span>PRIME XR</span>
                    <span>BEST</span>
                  </div>
                </div>
            ...
            <div className="animate-card text-center">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4" style={{ color: '#1393c4' }}>Select the Coverage</h3>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <img
                  src="https://actioncardetailing.ca/wp-content/uploads/2021/05/action1.jpg.webp"
                ...
                <div className="flex justify-center space-x-2">
                  {tintOptions.map((tint) => (
                    <button
                      key={tint}
                      className={`px-3 py-2 rounded text-sm sm:text-base ${selectedTint === tint
                        ? 'text-white'
                        : 'hover:opacity-80'
                        }`}
                      style={{
            ...
            <div className="animate-card text-center">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4" style={{ color: '#1393c4' }}>Select the Shade</h3>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <img
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4 leading-tight" style={{ color: '#1393c4' }}>
            1. WHAT FILM?
          </h2>
          <p className="text-center max-w-4xl mx-auto mb-8 text-sm sm:text-base md:text-lg leading-relaxed" style={{ color: '#1393c4' }}>
          ...
          <p className="text-center max-w-4xl mx-auto mb-16 text-sm sm:text-base md:text-lg font-semibold" style={{ color: '#1393c4' }}>
              ...
              <div key={key} className={`animate-card rounded-xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 ${selectedFilm === key ? 'ring-4' : ''}`}
                ...
                <div className="p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2" style={{ color: '#1393c4' }}>{film.name}</h3>
                    <div className="mb-4">
                      <img
                        src={film.logo}
                        alt={`${film.name} Logo`}
                    ...
                    <p className="font-semibold text-sm sm:text-base md:text-lg" style={{ color: '#1393c4' }}>{film.subtitle}</p>
                  </div>
                  ...
                  <div className={`text-center text-2xl sm:text-3xl md:text-4xl font-black mb-6`} style={{ color: '#1393c4' }}>
                    {film.grade}
                  </div>

                  <p className="text-xs sm:text-sm md:text-base leading-relaxed mb-6" style={{ color: '#1393c4' }}>{film.description}</p>

                  <div className="space-y-3">
                    {film.features.map((feature, index) => (
                      <div key={index} className="flex items-start space-x-2">
                        <CheckCircle className="mt-0.5 flex-shrink-0" style={{ color: '#1393c4' }} size={16} />
                        <span className="text-xs sm:text-sm" style={{ color: '#1393c4' }}>{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-8 leading-tight" style={{ color: '#1393c4' }}>
            2. WHAT COVERAGE?
          </h2>
          <p className="text-center max-w-4xl mx-auto mb-16 text-sm sm:text-base md:text-lg leading-relaxed" style={{ color: '#1393c4' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="animate-card text-center">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-8" style={{ color: '#1393c4' }}>TWO FRONTS ONLY:</h3>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <button
                  onClick={() => setShowQuote(true)}
                  className="text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:opacity-90 text-sm sm:text-base"
                  style={{ backgroundColor: '#1393c4' }}
                >
                  Get A Quote
                </button>
            ...
            <div className="animate-card text-center">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-8" style={{ color: '#1393c4' }}>SIDES AND BACK:</h3>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <img
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center max-w-4xl mx-auto mb-12 text-sm sm:text-base md:text-lg leading-relaxed" style={{ color: '#1393c4' }}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="animate-card text-center">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6" style={{ color: '#1393c4' }}>WE PREP</h3>
            ...
            <div className="animate-card text-center">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6" style={{ color: '#1393c4' }}>WE PLOT</h3>
              <div className="bg-white rounded-xl overflow-hidden mb-6 shadow-lg">
                <img
            ...
            <div className="animate-card text-center">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6" style={{ color: '#1393c4' }}>WE EXECUTE</h3>
              <div className="bg-white rounded-xl overflow-hidden mb-6 shadow-lg">
                <img
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-12 max-w-2xl mx-auto font-medium" style={{ color: '#1393c4' }}>
            Experience the ultimate in UV protection, heat rejection, and style with our professional window tinting services.
          </p>
          <button
            onClick={() => setShowQuote(true)}
            className="text-white px-12 py-4 rounded-full text-lg sm:text-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-2xl hover:opacity-90"
            style={{ backgroundColor: '#1393c4' }}
          >
